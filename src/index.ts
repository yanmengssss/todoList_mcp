      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            status: {
              type: "string",
              description: "按状态筛选（pending/in-progress/completed）",
            },
            priority: {
              type: "number",
              description: "按优先级筛选（1-5）",
            },
            favorite: {
              type: "boolean",
              description: "按是否收藏筛选",
            ...
            needTips: {
              type: "boolean",
              description: "按是否需要提醒筛选",
            },
            endAtStart: {
              type: "string",
              description: "截止时间范围-开始（ISO 8601格式）",
            },
            endAtEnd: {
              type: "string",
              description: "截止时间范围-结束（ISO 8601格式）",
            },
            completedAtStart: {
              type: "string",
              description: "完成时间范围-开始（ISO 8601格式）",
            },
            completedAtEnd: {
              type: "string",
              description: "完成时间范围-结束（ISO 8601格式）",
            },
            createdAtStart: {
              type: "string",
              description: "创建时间范围-开始（ISO 8601格式）",
            },
            createdAtEnd: {
              type: "string",
              description: "创建时间范围-结束（ISO 8601格式）",
            },
          },
          required: ["userID"],
        },
    ...
    switch (name) {
      ...
      case "get_tasks": {
        ...
        const filter = {
          ...
          favorite: args?.favorite as boolean | undefined,
          needTips: args?.needTips as boolean | undefined,
          endAtStart: args?.endAtStart as string | undefined,
          endAtEnd: args?.endAtEnd as string | undefined,
          completedAtStart: args?.completedAtStart as string | undefined,
          completedAtEnd: args?.completedAtEnd as string | undefined,
          createdAtStart: args?.createdAtStart as string | undefined,
          createdAtEnd: args?.createdAtEnd as string | undefined,
        };
        const tasks = await getTaskList(userID, filter);
        return {
          content: [
            {
              type: "text" as const,
